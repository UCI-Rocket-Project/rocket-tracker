import logging
from .utils import toHex, crc16_str_swap
...
class SIYIMESSAGE:
    ...
    def encodeMsg(self, data, cmd_id):
        ...
        # 0000 is the sequence number. This used to be actually be incremented each
        # time but we removed that for some reason unknown to me.
